                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="provinces_id" v-if="provinces"
                                                    v-model="provinces_id" name="provinces_id">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="regencies_id" v-if="regencies"
                                                    v-model="regencies_id" name="regencies_id">
